    ...
    try {
        ...
        if(impuestosF !== undefined)
        {
            ...
            if(trasladosN !== undefined)
            {
                ...
                {
                    cadenaIVA = "I.V.A. 16%\n\n";
                    cadenaIVAValor = "$" + parseFloat(iva16.attributes.Importe).toLocaleString("en") + "\n\n"
                }
                ...
                {
                    cadenaIVA = "I.V.A. 0%\n\n";
                    cadenaIVAValor = "$" + parseFloat(iva0.attributes.Importe).toLocaleString("en") + "\n\n"
                }
            }
        }
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {border: [false, true, true, true], text:  `DEBO(EMOS) Y PAGARE(MOS) A LA ORDEN DE ITW POLY MEX S DE RL DE CV A LA VISTA LA CANTIDAD INDICADA, PAGOS EFECTUADOS DESPUES DEL VENCIMIENTO CAUSARÁN INTERESES MORATORIOS A RAZÓN DEL % MENSUAL. \n\n ${totalLetra} ${attributes.Moneda}`, alignment: 'left', style: "textotablaEmisorReceptor"},
...
//getPDFPolymex(ingreso5, "/Users/alexishernandezolvera/Desktop/IPM6203226B4_RI_217_20220711.txt", "/Users/alexishernandezolvera/Desktop/GTC/PROYECTOS/gtc-services-portal-api/utils/images/Logo_Polymex.png")
