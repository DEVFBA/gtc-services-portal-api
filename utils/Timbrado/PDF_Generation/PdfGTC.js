...
async function getPDFGtc(docBase64, pathLogo)
{
    ...
    try {
            ...
            if(i !== conceptos.elements.length-1)
            {
                    ...
                    for(var j=0; j<traslados.elements.length; j++)
                    {
                        if(j===0)
                        {
                            ...
                            concepts[psItems] = [
                                ...
                                {border: [true, true, true, true], text: "$" + parseFloat(traslados.elements[j].attributes.Importe).toLocaleString("en"), style: 'textotabla', alignment: "center"},
                                {border: [false, false, true, false], text:""}, 
                            ]
                    ...
                    for(var j=0; j<retenciones.elements.length; j++)
                    {
                        if(j===0)
                        {
                            ...
                            concepts[psItems] = [
                                ...
                                {border: [true, true, true, true], text: "$" + parseFloat(retenciones.elements[j].attributes.Importe).toLocaleString("en"), style: 'textotabla', alignment: "center"},
                                {border: [false, false, true, false], text:""}, 
                            ]
                ...
                if(traslados !== undefined)
                {
                    ...
                    concepts[psItems] = [
                        ...
                        {border: [false, false, true, true], text: "$" + parseFloat(conceptos.elements[i].attributes.Importe).toLocaleString("en"), style: 'textotabla', alignment: "center"}, 
                    ]
        ...
        if(trasladosN === undefined)
        {
            ...
            impT = "$" + parseFloat(trasladosN.elements[0].attributes.Importe).toLocaleString("en");
        }
        ...
        if(retencionesN === undefined)
        {
            ...
            impR = "$" + parseFloat(retencionesN.elements[0].attributes.Importe).toLocaleString("en");
        }
        ...
        concepts[psItems] = [
            ...
            {border: [true, false, true, false], text: "$" + parseFloat(attributes.SubTotal).toLocaleString("en"), style: 'textotabla', alignment: "right"}, 
        ]
        ...
        concepts[psItems] = [
            ...
            {border: [true, true, true, true], text: "$" + parseFloat(attributes.Total).toLocaleString("en"), style: 'textotablaboldblack', alignment: "right"}, 
        ]
...
//getPDFGtc(xmlPagos, "/Users/alexishernandezolvera/Desktop/GTC/PROYECTOS/gtc-services-portal-api/utils/images/LogoGTC.png")
