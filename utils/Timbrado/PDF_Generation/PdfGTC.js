    ...
    try {
        ...
        var encabezado2 = {
            table: {
                ...
                body: [
                    [
                        {fillColor: "#1C932B", text:"CFDI versión " + attributes.Version , alignment: 'center', style: 'textotablawhite'},
                    ],
                ]
            },
            layout: {
        ...
        var monedaMetodo = 
        {
            table: {
                ...
                body: [
                    [
                        {fillColor: "#1C932B", border: [true, true, true, false], text: `Moneda`, style: 'textotablacolor', alignment: "center"},
                        {fillColor: "#1C932B", border: [true, true, true, false], text: `Método de Pago`, style: 'textotablacolor', alignment: "center"}, 
                        {fillColor: "#1C932B", border: [true, true, true, false], text: `UUID`, style: 'textotablacolor', alignment: "center"}, 
                    ],
                    [
                        ...
                        {border: [true, false, true, true], text: timbreFiscal.attributes.UUID, style: 'textotabla', alignment: "center"}, 
                    ],
                ]
            },
            layout: {
                    ...
                    for(var j=0; j<traslados.elements.length; j++)
                    {
                        if(j===0)
                        {
                            concepts[psItems] = [
                                ...
                                {border: [false, false, false, false], text: "Tipo Factor", style: 'textotabla2', alignment: "center"}, 
                                {border: [false, false, false, false], text: "Tasa O Cuota", style: 'textotabla2', alignment: "center"}, 
                                {border: [false, false, false, false], text: "Importe", style: 'textotabla2', alignment: "center"},
                            ...
                            concepts[psItems] = [
                                ...
                                {fillColor: "#020167", border: [true, true, true, true], text: "Base", style: 'textotabla2', alignment: "center"},
                                {fillColor: "#020167", border: [true, true, true, true], text: "Impuesto", style: 'textotabla2', alignment: "center"}, 
                                {fillColor: "#020167", border: [true, true, true, true], text: "Tipo Factor", style: 'textotabla2', alignment: "center"}, 
                                {fillColor: "#020167", border: [true, true, true, true], text: "Tasa O Cuota", style: 'textotabla2', alignment: "center"}, 
                                {fillColor: "#020167", border: [true, true, true, true], text: "Importe", style: 'textotabla2', alignment: "center"},
                                {border: [false, false, true, false], text:""}, 
                            ]
                            ...
                            concepts[psItems] = [
                                ...
                                {border: [true, true, true, true], text: traslados.elements[j].attributes.Base, style: 'textotabla', alignment: "center"},
                                {border: [true, true, true, true], text: traslados.elements[j].attributes.Impuesto, style: 'textotabla', alignment: "center"}, 
                                {border: [true, true, true, true], text: traslados.elements[j].attributes.TipoFactor, style: 'textotabla', alignment: "center"}, 
                                {border: [true, true, true, true], text: traslados.elements[j].attributes.TasaOCuota, style: 'textotabla', alignment: "center"}, 
                                {border: [true, true, true, true], text: "$" + Intl.NumberFormat("en-IN").format(traslados.elements[j].attributes.Importe), style: 'textotabla', alignment: "center"},
                                {border: [false, false, true, false], text:""}, 
                            ]
                    ...
                    for(var j=0; j<retenciones.elements.length; j++)
                    {
                        if(j===0)
                        {
                            ...
                            concepts[psItems] = [
                                ...
                                {border: [true, true, true, true], text: "$" + Intl.NumberFormat("en-IN").format(retenciones.elements[j].attributes.Importe), style: 'textotabla', alignment: "center"},
                                {border: [false, false, true, false], text:""}, 
                            ]
        ...
        if(trasladosN === undefined)
        {
            ...
            impT = "$" + Intl.NumberFormat("en-IN").format(trasladosN.elements[0].attributes.Importe)
        }
        ...
        if(retencionesN === undefined)
        {
            ...
            impR = "$" + Intl.NumberFormat("en-IN").format(retencionesN.elements[0].attributes.Importe)
        }
        ...
        concepts[psItems] = [
            ...
            {border: [true, false, true, false], text: "$" + Intl.NumberFormat("en-IN").format(attributes.SubTotal), style: 'textotabla', alignment: "right"}, 
        ]
        ...
        concepts[psItems] = [
            ...
            {border: [true, true, true, true], text: "$" + Intl.NumberFormat("en-IN").format(attributes.Total), style: 'textotablaboldblack', alignment: "right"}, 
        ]
        ...
        if(complementoPago !== undefined)
        {
            ...
            compP[psItems] = [
                {fillColor: "#1C932B", border: [true, true, true, true], text: `PAGO`, style: 'textotablacolor', alignment: "center", colSpan:9},
                {},
                {},
                {},
                {},
...
getPDFGtc(xml649, "/Users/alexishernandezolvera/Desktop/IPM6203226B4_RI_90382_20220318.txt", "/Users/alexishernandezolvera/Desktop/GTC/PROYECTOS/gtc-services-portal-api/utils/images/LogoGTC.png")
