...
async function getPDFCasaDiaz(docBase64, pathLogo, nameFile, domicilioFiscal)
{
            ...
            for(var i=0; i<mercanciasAux.length; i++)
            {
                if(cartaP.attributes.TranspInternac === "Si" || cartaP.attributes.TranspInternac === "Sí" || cartaP.attributes.TranspInternac === "SI" || cartaP.attributes.TranspInternac === "si" || cartaP.attributes.TranspInternac === "sí")
                {
                    if(cartaP.attributes.EntradaSalidaMerc === "Entrada")
                    {
                        ...
                        var pedimentos = mercanciasAux[i].elements
                        if(pedimentos.length > 0)
                        {
                            var pCount = 1
                            for(var p = 0; p< pedimentos.length; p++)
                            {
                                mercanciasArray[mCount] = [
                                ...
                                mercanciasArray[mCount] = [
                                    {text: `${pedimentos[p].attributes.Pedimento}`, alignment: 'center', style: 'ubicacionesTexto', colSpan: 7},
                                    {},
                                    {},
                                    {},
                                    {},
...
//getPDFCasaDiaz(xml645, "/Users/alexishernandezolvera/Desktop/GTC/PROYECTOS/gtc-services-portal-api/utils/images/Logo_Casa_Diaz.jpg", "./Documento" , "DOMICILIO DEL CLIENTE")
